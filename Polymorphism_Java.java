public class Polymorphism_Java {            // Polymorphism in Java is the ability of an object to take on
...
class boy extends Polymorphism_Java {           // class 'Ik' is a child of the class 'Inheritance';
