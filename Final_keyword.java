class Motorcycle {
    final int SPEEDLIMIT = 90; // -> the name of the 'final' variable should have the capital letters;
                          //   NOTE: all the modifies (i.e. the public, private, e.t.c. can also be used in combination with the 'final' key word);
...
public class Final_keyword {
    ...
    public static void main(String[] args) {
         ...
         * 2. methods -> it prevents changing the override methods.
