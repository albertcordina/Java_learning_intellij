...
public class HashMap_Linked_Tree_rules {
    ...
    public static void main(String[] args) {
        ...
        // the 'LinkedHashMap' in compare with 'HashMap' maintains the order (i.e. keeps all the elements in a particular order);
        ...
        // it automatically sorts the elements according to the 'key' (i.e. the first element) 'numerical' or 'alphabetical' order;
