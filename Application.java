...
class Student extends Application {
    void eligibility() {
        ...
        String outcome = (age > 65) ? ", your age is over 65 years, therefore, please, for a further support apply to the '...' department" :
                (lengthOfNotSupported < 2) ? ", you have been supported during the last two years, therefore, for a further support we recommend " +
                        "you to contact the '...' department" : (grade > 3) ? ", your grade is higher the 3rd grade, therefore, we recommend you to" +
                        " contact the following department" : (istYes) ? ", you are having an additional income besides the scholarship, therefore, " +
                        "we recommend you to contact the following department" : ", your application will be reviewed.";
        System.out.println("\nDear, " + name + outcome);
        scanner.close();
    }
}
...
class Worker extends Application {
    void eligibility() {
        ...
        String outcome = (age > 65) ? ", your age is over 65 years, therefore, please, for a further support apply to the '...' department" :
                (lengthOfNotSupported < 2) ? ", you have been supported during the last two years, therefore, for a further support we recommend " +
                        "you to contact the '...' department" : (income > 2000) ? ", your monthly income is over than 2000 Euros, therefore, we recommend " +
                        "you to contact the following department ... " : ", your application will be reviewed.";
        System.out.println("\nDear, " + name + outcome);
        scanner.close();
    }
}
