 ...
 *   class (only different variables, Interface has only unchangeable variables).
 *
 *  'Interface' is a completely "abstract class" that is used to group related methods with empty bodies:
 *    all the variables within the 'Interface' are automatically set as    'public static final',
...
public class Interface_rules implements Interfaces_example {

    public static void main(String[] args) {
        Interface_rules rules = new Interface_rules ();
        rules.play();
    }
