...
public class GenericsExample { // 'Generics' has been created for safety reason to have the only specific type of object;
...
class Cat3 extends Animal3 {
    ...
    public Cat3 (String name) {this.name = name;}
    public Cat3 () {}
...
class Dog3 extends Animal3 {int walkDistancePreference;}
